...
| 4 | DX-1 | **DONE** ✅ | Sprint B | ~~Create `docs/ONBOARDING.md`~~ — 556-line progressive tutorial created (2026-03-11) | 5 | M | Docs | DX-1 |
| 5 | DX-3 | **DONE** ✅ | Sprint B | ~~Create a Pattern Catalog~~ — `docs/PATTERN_CATALOG.md` (443 lines) maps ReAct, CoVe, ToT, RRF, confidence gating (2026-03-11) | 5 | M | Docs | DX-3 |
...
| 11 | DX-4 | **PARTIAL** 🟡 | Sprint B | Add 5-8 examples — 6 created (simple_agent, workflow_run, yaml_workflow, custom_tool + 2 YAML definitions); remaining: RAG pipeline, adapter switching | 5 | M | Docs | DX-4 |
...
| 16 | CQ-4/5 | **PARTIAL** 🟡 | Sprint C | Modernize `tools/` package — PEP 604 migration done (C11), print→logging done for core+llm (C12-C13); remaining: `from __future__ import annotations`, residual prints | 3 | M | Code Quality | CQ-4/5 |
...
| 18 | DX-5 | **DONE** ✅ | Sprint B | ~~Add YAML workflow authoring guide~~ — `docs/WORKFLOW_AUTHORING.md` (833 lines) with expression syntax, conditions, loops (2026-03-11) | 4 | M | Docs | DX-5 |
| 19 | ML-4 | **DONE** ✅ | Sprint C | ~~Add re-ranking stage to RAG pipeline~~ — RerankerProtocol + 3 implementations (NoOp, CrossEncoder, LLM) wired into HybridRetriever (C16a-c, 2026-03-12) | 4 | M | ML/AI | ML-4 |
...
| DX-1 | Onboarding guide — `docs/ONBOARDING.md` (556 lines) | 2026-03-11 | Progressive tutorial: setup → workflow → agent → evaluation |
| DX-3 | Pattern Catalog — `docs/PATTERN_CATALOG.md` (443 lines) | 2026-03-11 | Maps ReAct, CoVe, ToT, RRF, confidence gating to implementations |
| DX-5 | Workflow authoring guide — `docs/WORKFLOW_AUTHORING.md` (833 lines) | 2026-03-11 | Expression syntax, `when:` conditions, `loop_until:`, agent naming |
| ML-4 | RAG re-ranking — RerankerProtocol + 3 implementations | 2026-03-12 | NoOp, CrossEncoder, LLM rerankers wired into HybridRetriever (C16a-c) |
...
### Sprint B — Educational Materials ✅ COMPLETE

All 4 items completed (2026-03-11 through 2026-03-12).

| # | ID | Item | Status |
|---|----|------|--------|
| 12 | DX-1 | Create `docs/ONBOARDING.md` progressive tutorial | **DONE** ✅ |
| 13 | DX-3 | Create Pattern Catalog | **DONE** ✅ |
| 14 | DX-4 | Add 5-8 code examples | **PARTIAL** 🟡 (6 of 8) |
| 15 | DX-5 | Add YAML workflow authoring guide | **DONE** ✅ |

### Sprint C — Architecture Hardening (~2-3 weeks)

| # | ID | Item | Status |
|---|----|------|--------|
| 16 | ARCH-1 | Tighten protocol type signatures (bounded TypeVars) | BACKLOG |
| 17 | ARCH-4 | Add cross-package integration tests | BACKLOG |
| 18 | ML-4 | Add re-ranking stage to RAG pipeline | **DONE** ✅ |
| 19 | CQ-4/5 | Modernize tools/ package | **PARTIAL** 🟡 |

### Sprint D — Advanced Patterns (~4+ weeks)

| # | ID | Item | Status |
|---|----|------|--------|
| 20 | ML-2 | Implement BaseAgent reflection/self-correction loop | BACKLOG |
| 21 | ML-5 | Integrate online evaluation feedback loop | BACKLOG |
