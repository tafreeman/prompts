...
class Generator:
    ...
    def generate_draft(self, category: str, use_case: str, variables: Dict[str, str]) -> str:
        """
    ...
    def _build_generation_prompt(self, category: str, use_case: str, variables: Dict[str, str]) -> str:
        """
