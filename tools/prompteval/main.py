...
This script demonstrates loading prompt files and metadata from registry.yaml.
"""
...
if __name__ == '__main__':
    ...
    for path in reg.list_prompt_paths():
        ...
        print(f"{path}: {meta.get('title')} | Platforms: {meta.get('platforms')} | Audience: {meta.get('audience')}")
