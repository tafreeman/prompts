...
# ═══════════════════════════════════════════════════════════════════════════════
# LOCAL MODEL REGISTRY - All available ONNX models in AI Gallery cache
# ═══════════════════════════════════════════════════════════════════════════════
# Note: Paths use double-dash format from AI Gallery (microsoft--ModelName)

MODEL_REGISTRY = {
    # ─────────────────────────────────────────────────────────────────────────────
    # PHI-4 (Latest - 3.8B params)
    # ─────────────────────────────────────────────────────────────────────────────
    "phi4": Path(r"C:\Users\tandf\.cache\aigallery\microsoft--Phi-4-mini-instruct-onnx\main\cpu_and_mobile\cpu-int4-rtn-block-32-acc-level-4"),
    "phi4mini": Path(r"C:\Users\tandf\.cache\aigallery\microsoft--Phi-4-mini-instruct-onnx\main\cpu_and_mobile\cpu-int4-rtn-block-32-acc-level-4"),
    
    # ─────────────────────────────────────────────────────────────────────────────
    # PHI-3.5 (3.8B params)
    # ─────────────────────────────────────────────────────────────────────────────
    "phi3.5": Path(r"C:\Users\tandf\.cache\aigallery\microsoft--Phi-3.5-mini-instruct-onnx\main\cpu_and_mobile\cpu-int4-awq-block-128-acc-level-4"),
    "phi3.5-vision": Path(r"C:\Users\tandf\.cache\aigallery\microsoft--Phi-3.5-vision-instruct-onnx\main\cpu_and_mobile\cpu-int4-rtn-block-32-acc-level-4"),
    
    # ─────────────────────────────────────────────────────────────────────────────
    # PHI-3 MINI (3.8B params)
    # ─────────────────────────────────────────────────────────────────────────────
    "phi3": Path(r"C:\Users\tandf\.cache\aigallery\microsoft--Phi-3-mini-4k-instruct-onnx\main\cpu_and_mobile\cpu-int4-rtn-block-32-acc-level-4"),
    "phi3mini": Path(r"C:\Users\tandf\.cache\aigallery\microsoft--Phi-3-mini-4k-instruct-onnx\main\cpu_and_mobile\cpu-int4-rtn-block-32-acc-level-4"),
    
    # ─────────────────────────────────────────────────────────────────────────────
    # PHI-3 MEDIUM (14B params - larger, slower, more capable)
    # ─────────────────────────────────────────────────────────────────────────────
    "phi3-medium": Path(r"C:\Users\tandf\.cache\aigallery\microsoft--Phi-3-medium-4k-instruct-onnx-cpu\main\cpu-int4-rtn-block-32-acc-level-4"),
    
    # ─────────────────────────────────────────────────────────────────────────────
    # MISTRAL 7B (7B params)
    # ─────────────────────────────────────────────────────────────────────────────
    "mistral": Path(r"C:\Users\tandf\.cache\aigallery\microsoft--mistral-7b-instruct-v0.2-ONNX\main\onnx\cpu_and_mobile\mistral-7b-instruct-v0.2-cpu-int4-rtn-block-32-acc-level-4"),
    "mistral-7b": Path(r"C:\Users\tandf\.cache\aigallery\microsoft--mistral-7b-instruct-v0.2-ONNX\main\onnx\cpu_and_mobile\mistral-7b-instruct-v0.2-cpu-int4-rtn-block-32-acc-level-4"),
}

# Default search order (first found is used)
DEFAULT_MODEL_PATHS = [
    MODEL_REGISTRY["phi4"],      # Fastest, most recent
    MODEL_REGISTRY["phi3.5"],    # Good balance
    MODEL_REGISTRY["phi3"],      # Reliable fallback
    MODEL_REGISTRY["mistral"],   # Larger, more capable
    MODEL_REGISTRY["phi3-medium"],  # Largest local option
]
