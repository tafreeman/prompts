...
class TestGenerateText:
    ...
    def test_generate_text_with_temperature(self):
        ...
        try:
            response = LLMClient.generate_text(
                model="local:phi4mini", prompt="Hello", temperature=0.7, max_tokens=20
            )
...
class TestParameterValidation:
    ...
    def test_empty_prompt_handling(self):
        ...
        try:
            response = LLMClient.generate_text(
                model="local:phi4mini", prompt="", max_tokens=10
            )
...
class TestEdgeCases:
    ...
    def test_very_long_prompt(self):
        ...
        try:
            response = LLMClient.generate_text(
                model="local:phi4mini", prompt=long_prompt, max_tokens=20
            )
    ...
    def test_special_characters_in_prompt(self):
        ...
        try:
            response = LLMClient.generate_text(
                model="local:phi4mini", prompt=special_prompt, max_tokens=50
            )
