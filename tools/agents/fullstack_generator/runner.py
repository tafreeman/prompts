...
Examples:
    ...
    parser.add_argument(
        "requirements",
        nargs="?",
        help="Requirements for the application to generate"
    )
    parser.add_argument(
        "--file", "-f",
        help="Read requirements from file"
    )
    parser.add_argument(
        "--project", "-p",
    ...
    try:
        result = asyncio.run(run_fullstack_workflow(
            requirements=requirements,
