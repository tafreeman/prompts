from .dimensions import Criterion, Dimension, PerformanceLevel
...
TECHNICAL_QUALITY = Dimension(
    ...
    criteria=[
        Criterion(
            "clarity", "Unambiguous language, specific terminology, clear instructions"
        ),
        Criterion(
            "structure", "Logical organization, proper formatting, section coherence"
        ),
        Criterion(
            "syntax", "Grammatical accuracy, consistent style, appropriate punctuation"
        ),
        Criterion(
            "advanced_techniques",
            "Implementation of CoT, Few-Shot, ToT, ReAct, and other methodologies",
        ),
    ],
    rubric={
...
BUSINESS_ALIGNMENT = Dimension(
    ...
    criteria=[
        Criterion(
            "strategic_value",
            "Contribution to organizational objectives and priorities",
        ),
        ...
        Criterion(
            ...
            "Alignment with business user needs and expectations",
        ),
    ],
    rubric={
        PerformanceLevel.EXCEPTIONAL: {
...
SECURITY_COMPLIANCE = Dimension(
    ...
    criteria=[
        Criterion(
            "data_protection",
            "Handling of sensitive information, PII safeguards, data minimization",
        ),
        Criterion(
            "regulatory_compliance", "GDPR, CCPA, HIPAA, industry-specific requirements"
        ),
        Criterion(
            "risk_mitigation",
            "Prompt injection prevention, output validation, guardrails",
        ),
        Criterion(
            "privacy_safeguards", "User consent considerations, data retention policies"
        ),
    ],
    rubric={
        PerformanceLevel.EXCEPTIONAL: {
...
PERFORMANCE_RELIABILITY = Dimension(
    ...
    criteria=[
        Criterion(
            "output_consistency", "Reproducible results across multiple executions"
        ),
        Criterion(
            "accuracy", "Factual correctness and alignment with expected outcomes"
        ),
        Criterion(
            "response_quality", "Completeness, relevance, and usefulness of outputs"
        ),
        Criterion(
            "operational_effectiveness",
            "Token efficiency, latency optimization, error handling",
        ),
    ],
    rubric={
        PerformanceLevel.EXCEPTIONAL: {
...
MAINTAINABILITY = Dimension(
    ...
    criteria=[
        Criterion(
            "documentation",
            "Clear purpose statements, usage instructions, example outputs",
        ),
        Criterion(
            "version_control", "Change history, deprecation notices, migration guides"
        ),
        Criterion(
        ...
        Criterion(
            "modification_ease",
            "Modular structure, clear parameterization, extension points",
        ),
    ],
    rubric={
        PerformanceLevel.EXCEPTIONAL: {
...
INNOVATION_OPTIMIZATION = Dimension(
    ...
    criteria=[
        ...
        Criterion(
            "efficiency_improvements", "Token optimization, cost reduction strategies"
        ),
        Criterion(
            "technique_adoption",
            "Implementation of cutting-edge prompting methodologies",
        ),
