...
def main():
    ...
    print(f"\n{'='*60}")
    print("G-EVAL EVALUATION (Batch Mode)")
    ...
    model = LocalModel(
        model_path=str(
            Path.home()
            / ".cache/aigallery/microsoft--mistral-7b-instruct-v0.2-ONNX/main/onnx/cpu_and_mobile/mistral-7b-instruct-v0.2-cpu-int4-rtn-block-32-acc-level-4"
        ),
        verbose=False,
    )
    ...
    print(f"\n{'='*60}")
    print("FINAL SUMMARY - G-Eval (Mistral 7B)")
    print(f"{'='*60}")
