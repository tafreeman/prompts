...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"G-EVAL EVALUATION #2 (Batch Mode)")
    ...
    # Use Phi-3.5 Mini
    model = LocalModel(
        model_path=str(Path.home() / ".cache/aigallery/microsoft--Phi-3.5-mini-instruct-onnx/main/cpu_and_mobile/cpu-int4-awq-block-128-acc-level-4"),
        verbose=False
    )
    ...
    print(f"\n{'='*60}")
    print(f"FINAL SUMMARY - G-Eval (Phi-3.5 Mini)")
    print(f"{'='*60}")
