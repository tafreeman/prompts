...
STEP_OUTPUTS = {
    1: {
        "user_stories": [{"id": "US001", "title": "User Login"}],
    ...
    5: {
        ...
        "backend_files": [{"path": "main.py"}],
    },
    6: {
        "frontend_code": "import React from 'react'",
        "frontend_files": [{"path": "Login.tsx"}],
    },
    7: {
        "review_results": {"security": "PASS"},
        "issues": [{"severity": "low", "msg": "Add validation"}],
    },
...
async def main():
    ...
    result = await workflow.execute(
        {"requirements": "Build a simple todo app with user authentication"}
    )
    return result
