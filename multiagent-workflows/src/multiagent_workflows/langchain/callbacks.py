...
Provides callback handlers that align LangChain run outputs with
the existing evaluation and logging expectations in the multiagent-workflows engine.
"""
...
UI_SCORING_CATEGORIES = {
    ...
    "quality": {"weight": 25, "description": "Code quality (style, structure, patterns)"},
...
class EvaluationCallbackHandler(WorkflowCallbackHandler):
    ...
    Integrates the UI scoring categories (Correctness, Quality, Documentation, etc.)
    """
    ...
    def _run_evaluation(
        ...
        try:
            ...
            overall_percentage = (weighted_score / total_weight * 100) if total_weight > 0 else 0
            ...
            eval_result = {
                ...
                "documentation": round(category_scores.get("documentation", 0) * 100, 1),
    ...
    def _compute_category_scores(
        ...
        if isinstance(outputs, str):
            ...
            output_str = outputs.get("code", "") or outputs.get("output", "") or outputs.get("result", "")
    ...
    def _heuristic_scores(
        ...
        doc_score = 0.0
        doc_indicators = ["README", "##", "Usage", "Example", '"""', "Args:", "Returns:"]
