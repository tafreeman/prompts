...
from multiagent_workflows.core.tool_registry import (
    ToolDefinition,
    ToolRegistry,
...
def tool_definition_to_langchain(tool_def: ToolDefinition) -> Any:
    ...
    Returns a LangChain Tool object if langchain is available, otherwise
    returns a compatible dict structure.
    """
    try:
        ...
        return {
            ...
            or _generate_schema_from_function(tool_def.handler),
