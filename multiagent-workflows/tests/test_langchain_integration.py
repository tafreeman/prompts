...
class TestWorkflowState:
    ...
    def test_get_state_class_fullstack(self):
        ...
        from multiagent_workflows.langchain.state import FullStackState, get_state_class
    ...
    def test_get_state_class_bug_fixing(self):
        ...
        from multiagent_workflows.langchain.state import BugFixingState, get_state_class
...
class TestAgentChainFactory:
    ...
    def mock_model_manager(self):
        ...
        manager.generate_text = MagicMock(
            return_value=MagicMock(text='{"result": "test"}')
        )
...
class TestLangChainOrchestrator:
    ...
    def mock_model_manager(self):
        ...
        manager.get_optimal_model = MagicMock(return_value="mock:test")
        manager.generate_text = MagicMock(
            return_value=MagicMock(text='{"result": "ok"}')
        )
