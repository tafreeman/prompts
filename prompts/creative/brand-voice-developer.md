...
Develop and document a brand's voice, tone, and personality for consistent communication across all channels. Useful for new brands, rebrands, or team alignment.
...
- Key Attributes: [CONFIDENT/CLEAR/FRIENDLY/ETC.]
...
| :--- | ------------- |
| `[BRAND NAME]` | The name of the brand or product |
| `[INDUSTRY]` | The industry or market |
| `[TARGET AUDIENCE]` | Who the brand is speaking to |
| `[KEY ATTRIBUTES]` | Core voice traits (e.g., confident, clear, witty) |
| `[EXAMPLE PHRASES]` | Sample lines that capture the brand's style |
...
**Key Attributes:** Capable, Clear, Clever

**Brand Voice Summary:**
Capable, clear, and just clever enough to be interesting. Catalyst sounds like your smartest, most helpful teammate—the one who actually explains things clearly, never wastes your time, and occasionally makes you laugh.
