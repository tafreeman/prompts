...
testing:
  ...
  test_cases: ["sql-injection-check", "permission-audit"]
governance:
  risk_level: "high"
...
- **Refined Tips**: Added specific advice on `sp_executesql` and whitelisting.
- **Updated Metadata**: Added GDPR, PCI-DSS, HIPAA to regulatory scope.
- **Example**: Added detailed refactoring example with explanation.

### Version 1.0.0 (2025-11-21)

- Initial version derived from SQL security instructions and best practices.
