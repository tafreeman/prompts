...
### Version 2.3.0 (2025-11-28)
- **Model-Agnostic Reasoning**: Updated instructions to support both standard and reasoning models (o1).
- **Refined Instructions**: Clarified risk assessment and remediation steps.

### Version 2.2.0 (2025-11-27)
- **Quality Uplift**: Enhanced to Tier 1 standards (Score: 98/100).
- **Restored Content**: Fixed file corruption issue.
