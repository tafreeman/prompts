...
3. **Strategic Options**
   - Present 3-4 viable strategic options
...
- `[WHAT YOU'RE TRYING TO DECIDE OR ACHIEVE]`: The strategic question or goal
- `[SMALL/MEDIUM/LARGE/ENTERPRISE]`: Organization size
- `[LEADER/CHALLENGER/FOLLOWER/NICHE]`: Current market position
...
**Current Situation:** Mid-sized B2B SaaS company experiencing 30% YoY growth but facing increased competition from both established players and new startups. Customer acquisition costs rising.
**Strategic Question/Goal:** Should we expand into the enterprise market or double down on SMB segment?

**Context:**
- Company size: MEDIUM (200 employees, $20M ARR)
- Market position: CHALLENGER
- Key competitors: Salesforce, HubSpot, smaller niche players
- Budget constraints: $3M available for strategic initiatives
...
- Enterprise competitors may target your SMB base with aggressive pricing
...
- Cons: Slower growth, still faces SMB competition
...
- Cons: Limits addressable market, still competitive
...
- Cons: Less control, revenue sharing, dependency on partner
- Resources: $1.5M (partnership development, integration work, SMB efficiency improvements)
...
4. Resource requirements align with available budget
...
4. Develop case studies from successful SMB customers scaling up
...
- Build enterprise features incrementally based on actual pipeline needs
...
- Protect SMB margins through automation and self-service
- Build moat through vertical expertise in top 2 SMB industries
...
- Conduct gap analysis: product requirements for mid-market
...
- Create mid-market pricing and packaging
- Develop enterprise sales playbook and collateral
...
- Develop vertical-specific features for top 2 SMB industries
- Scale PLG motions to reduce SMB CAC by 30%
- Close 5-10 mid-market deals ($50K-$200K ARR each)
...
- Ask follow-up questions to drill deeper into specific recommendations
