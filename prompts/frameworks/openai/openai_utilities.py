...
class OpenAIPromptUtilities:
    ...
    def optimize_system_message(
        self, role: str, goal: str, constraints: List[str]
    ) -> str:
        """Constructs a highly effective system message based on best
        practices."""
...
"""
    ...
    def validate_json_schema(self, schema: Dict) -> bool:
        """Basic validation to ensure a dict looks like a valid JSON schema for
        OpenAI functions."""
    ...
    def create_structured_output_prompt(self, data_structure: str) -> str:
        ...
        (useful for models that don't support native JSON mode or as
        reinforcement)."""
        return f"""
