...
class ClaudePromptOptimizer:
    ...
    def optimize_for_claude(
        self, prompt: str, optimization_type: str = "xml_structure"
    ) -> str:
...
"""
    ...
    def _apply_constitutional_principles(self, prompt: str) -> str:
        """Adds Constitutional AI principles to the prompt for safety and
        helpfulness."""
        principles = """
<constitution>
...
"""
    ...
    def _add_assistant_prefill(self, prompt: str) -> str:
        """Simulates the 'prefill' technique where we start the assistant's
        response.
...
"""
    ...
    def format_tool_definition(
        self, tool_name: str, description: str, parameters: Dict
    ) -> Dict:
