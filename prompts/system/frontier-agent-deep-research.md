...
Enable autonomous AI agents to conduct deep research by searching the web, downloading documents, extracting text, and synthesizing findings into comprehensive State of the Art reports.
...
- **Track execution time**: Monitor how long each research phase takes to optimize future queries## Variables
...
| `[example-research-output.md]` | AUTO-GENERATED: describe `example-research-output.md` |
