...
intro: "An autonomous single-agent pattern for comprehensive C#/.NET code review that handles the entire review lifecycle from initial analysis through generating actionable feedback."
type: "how_to"
...
testing:
  ...
  test_cases: ["dotnet-security", "async-patterns", "entity-framework"]
governance:
  risk_level: "low"
