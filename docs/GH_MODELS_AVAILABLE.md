---
title: GitHub Models Available (as of Dec 2025)
description: List of all chat models available to the current account via `gh models list`
date: 2025-12-30
---

# GitHub Models Available (as of Dec 2025)

This document lists all chat models currently available to your account via the GitHub CLI (`gh models list`).
...
---
*Generated from `gh models list` output. For more details or capabilities, run `gh models list --json ...`.*