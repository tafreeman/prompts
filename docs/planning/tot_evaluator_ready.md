# Tree-of-Thoughts Repository Evaluator - Ready to Submit

Use the System Message and User Message below with a frontier reasoning model (Claude 3.5, GPT-4o, etc.)
...
**Goal:** Assess the repository's fitness as definitive source of highly curated prompt library in AI & engineering (e.g., M365 Copilot, GitHub Copilot, internal AI portals).
...
1. Copy the **System Message** and paste it into the system/developer prompt field
2. Copy the **User Message** and paste it into the user message field
3. Send to Claude 3.5 Sonnet, GPT-4o, or similar frontier model
4. Wait for the comprehensive ToT evaluation (may take 1-2 minutes)
