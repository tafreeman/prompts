...
Structured Output:
  ...
  - Each finding:
      { line, severity, cwe, cvss_score, description, exploit, remediation }
...
Examples: 1. E-commerce schema (orders, products, customers, inventory)
...
Examples: 1. Python API client with async/await, retries, error handling, tests
...
**P3 Priority (Nice-to-have)**: 4. `documentation-generator` - API docs, technical writing standards, doc-as-code 5. `mobile-app-developer` - iOS/Android patterns, cross-platform (React Native, Flutter) 6. `code-review-assistant` - Lightweight version optimized for quick reviews
...
_Total estimated effort_: **140-160 hours** for all 10 prompts  
_Timeline_: **16-20 weeks** (batched approach)  
_Expected outcome_: **59% of developer prompts at Tier 1 quality**
