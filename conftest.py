"""Lightweight pytest helper to run async test functions when pytest-asyncio is
...
def pytest_pyfunc_call(pyfuncitem):
    ...
    Returning True tells pytest that we've executed the test and it
    should not attempt to run it again.
    """
