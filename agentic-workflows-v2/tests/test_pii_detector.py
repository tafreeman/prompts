...
class TestEmailDetection:
    ...
    async def test_detects_multiple_emails(self, detector: PIIDetector) -> None:
        ...
        email_findings = [f for f in findings if f.category == FindingCategory.PII_EMAIL]
...
class TestPhoneDetection:
    ...
    async def test_detects_us_phone(self, detector: PIIDetector) -> None:
        ...
        phone_findings = [f for f in findings if f.category == FindingCategory.PII_PHONE]
...
class TestCleanText:
    ...
    async def test_no_pii_in_code(self, detector: PIIDetector) -> None:
        findings = await detector.scan("def calculate_sum(a: int, b: int) -> int: return a + b")
