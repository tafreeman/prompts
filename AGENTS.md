...
- **Subproject notes** — Some folders ship their own Claude guidance:
  - `presentation/CLAUDE.md` for the presentation system
...
3. Keep subproject-specific guidance close to the code (e.g., `presentation/CLAUDE.md`) and link back to `.claude/rules/` rather than duplicating content.
