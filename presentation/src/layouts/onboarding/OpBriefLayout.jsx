...
import { UI } from "../../tokens/ui-strings.js";

export function OpBriefLayout({ topic, onBack }) {
  const T = useTheme();
  const C = useChrome();
...
OpBriefLayout.propTypes = { topic: PropTypes.object.isRequired, onBack: PropTypes.func.isRequired };
